...
public class SimpleMailSender extends BaseAction {    
/**   
  * 以文本格式发送邮件   
  ...
  */    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("yanhaomail@foxmail.com");    
	     mailInfo.setPassword("tttt");//您的邮箱密码    
	     mailInfo.setFromAddress("yanhaomail@foxmail.com");    
	     mailInfo.setToAddress("250530182@qq.com");    
